...
function E(a,b){if(Array.isArray(a)){for(var c=Array(a.length),d=0;d<a.length;d++)c[d]=D(a[d],b);if(a){var e;A?e=a[A]:e=a.g;a=null==e?0:e}else a=0;a&1&&B(c);return c}e={};for(c in a)e[c]=D(a[c],b);return e}
;var F;function G(a,b,c){var d=F;F=null;a||(a=d);d=this.constructor.V;a||(a=d?[d]:[]);this.h=(d?0:-1)-(this.constructor.U||0);this.g=a;a:{d=this.g.length;a=d-1;if(d&&(d=this.g[a],C(d))){this.j=a-this.h;this.i=d;break a}void 0!==b&&-1<b?(this.j=Math.max(b,a+1-this.h),this.i=null):this.j=Number.MAX_VALUE}if(c)for(b=0;b<c.length;b++)a=c[b],a<this.j?(a+=this.h,(d=this.g[a])?B(d):this.g[a]=H):(d=this.j+this.h,this.g[d]||(this.i=this.g[d]={}),(d=this.i[a])?B(d):this.i[a]=H)}
var H=Object.freeze(B([]));G.prototype.toJSON=function(){return E(this.g,fa)};
...
q(J,G);var K,L,M,N=t.window,O=(null===(K=null===N||void 0===N?void 0:N.yt)||void 0===K?void 0:K.config_)||(null===(L=null===N||void 0===N?void 0:N.ytcfg)||void 0===L?void 0:L.data_)||{},P=(null===(M=null===N||void 0===N?void 0:N.ytcfg)||void 0===M?void 0:M.obfuscatedData_)||[];function ha(){J.apply(this,arguments)}
q(ha,J);new ha(P);w("yt.config_",O);w("yt.configJspb_",P);function Q(a,b){return a in O?O[a]:b}
...
function R(a){a=void 0===a?{}:a;I.call(this);this.g=[];this.g[8]=[];this.g[4]=[];this.g[3]=[];this.g[2]=[];this.g[1]=[];this.g[0]=[];this.j=0;this.N=a.timeout||1;this.i={};this.o=la;this.C=this.h=this.m=0;this.D=this.l=!1;this.u=[];this.H=v(this.R,this);this.M=v(this.T,this);this.J=v(this.O,this);this.K=v(this.P,this);this.L=v(this.S,this);this.A=this.F=!1;var b;if(b=!!window.requestIdleCallback)b=ja("disable_scheduler_requestIdleCallback"),b=!("string"===typeof b&&"false"===b?0:b);this.I=b;(this.v=
!!a.useRaf&&!!window.requestAnimationFrame)&&document.addEventListener("visibilitychange",this.H)}
q(R,I);function ma(a,b){var c=Date.now();S(b);b=Date.now()-c;a.l||(a.o-=b)}
