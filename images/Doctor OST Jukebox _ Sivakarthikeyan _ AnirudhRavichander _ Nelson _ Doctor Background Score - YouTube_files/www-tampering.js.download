...
;var F={},G=null;var da="function"===typeof Uint8Array;var H="function"===typeof Symbol&&"symbol"===typeof Symbol()?Symbol(void 0):void 0;function I(a){if(!Array.isArray(a))return a;Object.isFrozen(a)||(H?a[H]|=1:void 0!==a.g?a.g|=1:Object.defineProperties(a,{g:{value:1,configurable:!0,writable:!0,enumerable:!1}}));return a}
...
function L(a,b){if(Array.isArray(a)){for(var c=Array(a.length),d=0;d<a.length;d++)c[d]=K(a[d],b);if(a){var h;H?h=a[H]:h=a.g;a=null==h?0:h}else a=0;a&1&&I(c);return c}h={};for(c in a)h[c]=K(a[c],b);return h}
;var M;function N(a,b,c){var d=M;M=null;a||(a=d);d=this.constructor.o;a||(a=d?[d]:[]);this.i=(d?0:-1)-(this.constructor.m||0);this.g=a;a:{d=this.g.length;a=d-1;if(d&&(d=this.g[a],J(d))){this.l=a-this.i;this.j=d;break a}void 0!==b&&-1<b?(this.l=Math.max(b,a+1-this.i),this.j=null):this.l=Number.MAX_VALUE}if(c)for(b=0;b<c.length;b++)a=c[b],a<this.l?(a+=this.i,(d=this.g[a])?I(d):this.g[a]=O):(d=this.l+this.i,this.g[d]||(this.j=this.g[d]={}),(d=this.j[a])?I(d):this.j[a]=O)}
var O=Object.freeze(I([]));N.prototype.toJSON=function(){return L(this.g,ea)};
N.prototype.toString=function(){return this.g.toString()};var P=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function Q(a){return a?decodeURI(a):a}
;function R(a){N.call(this,a)}
B(R,N);var S,T,U,V=D.window,fa=(null===(S=null===V||void 0===V?void 0:V.yt)||void 0===S?void 0:S.config_)||(null===(T=null===V||void 0===V?void 0:V.ytcfg)||void 0===T?void 0:T.data_)||{},W=(null===(U=null===V||void 0===V?void 0:V.ytcfg)||void 0===U?void 0:U.obfuscatedData_)||[];function X(){R.apply(this,arguments)}
B(X,R);new X(W);E("yt.config_",fa);E("yt.configJspb_",W);Object.freeze(["js-httpswwwgoogleanalyticscomanalyticsjs","js-chromeextensionpkedcjkdefgpdelpbcmbmeomcjbeemfm","video-","js-http","css-http"]);
...
function Y(a){var b=a.match(P)[1]||null;return la.some(function(c){return b==c})}
function Z(a){var b=Q(a.match(P)[3]||null);return!b||Y(a)?!0:ia.some(function(c){return b==c})||ka.some(function(c){return b.endsWith(c)})}
function oa(a){if(!Y(a))return null;var b=Q(a.match(P)[3]||null);return b?ja.some(function(c){return b==c})?null:b:null}
